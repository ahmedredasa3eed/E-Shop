                                    ...
                                    <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
                                        <div class="product product-style-3 equal-elem ">
                                            ...
                                            <div class="product-info">
                                                <a href="{{route('frontend.product_details',$product->slug)}}" class="product-name"><span>{{$product->name}}</span></a>
                                                <div class="wrap-price"><span class="product-price">$ {{$product->regular_price}}</span></div>
                                                <a href="javascript:void(0);" wire:click.prevent="addToCart({{$product->id}},'{{$product->name}}',{{$product->regular_price}})" class="btn add-to-cart">Add To Cart</a>
                                                <div class="product_wish">
                                                    <!----Check if product is is found in wishlist id arrays;-->
                                                    @if($wishlist->contains($product->id))
                                                        <a href="javascript:void(0);" wire:click.prevent="removeFromWishList({{$product->id}})"><i class="fa fa-heart fill_heart"></i></a>
                                                    @else
                        ...
                        <div class="widget-content">
                            <ul class="list-category">
                                ...
                                <li class="category-item has-child-cate">
                                    <a href="{{route('frontend.category_products',$category->slug)}}" class="cate-link">{{$category->name}}</a>
...
@push('scripts')
    <script src="https://cdnjs.cloudflare.com/ajax/libs/noUiSlider/15.5.1/nouislider.min.js" integrity="sha512-T5Bneq9hePRO8JR0S/0lQ7gdW+ceLThvC80UjwkMRz+8q+4DARVZ4dqKoyENC7FcYresjfJ6ubaOgIE35irf4w==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>    <script>
