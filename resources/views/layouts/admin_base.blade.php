...
<div class="container-scroller">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
              ...
              <span class="menu-icon">
                ...
                <div class="collapse" id="categories">
                    <ul class="nav flex-column sub-menu">
                        ...
                        <li class="nav-item"> <a class="nav-link" href="{{route('admin.new_category')}}">Create Category</a></li>
                    </ul>
                </div>
            </li>
              ...
              <span class="menu-icon">
                ...
                <div class="collapse" id="products">
                    <ul class="nav flex-column sub-menu">
                        ...
                        <li class="nav-item"> <a class="nav-link" href="{{route('admin.new_product')}}">Create Product</a></li>
                    </ul>
                </div>
            </li>
              ...
              <span class="menu-icon">
                ...
                <div class="collapse" id="sliders">
                    <ul class="nav flex-column sub-menu">
                        ...
                        <li class="nav-item"> <a class="nav-link" href="{{route('admin.new_slider')}}">Create Slider</a></li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item menu-items">
                <a class="nav-link" href="{{route('admin.saleDataTimeSetting')}}">
              <span class="menu-icon">
                <i class="mdi mdi-playlist-play"></i>
              </span>
                    <span class="menu-title">Sale Setting</span>
                </a>
            </li>
            ...
            <li class="nav-item menu-items">
              ...
              <span class="menu-icon">
                ...
                <div class="collapse" id="coupons">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link" href="{{route('admin.coupons')}}">All Coupons</a></li>
                        <li class="nav-item"> <a class="nav-link" href="{{route('admin.new_coupon')}}">Create Coupon</a></li>
                    </ul>
                </div>
            </li>
            ...
            <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
                ...
                <ul class="navbar-nav navbar-nav-right">
                    <li class="nav-item dropdown d-none d-lg-block">
                        <a class="nav-link btn btn-success create-new-button"  aria-expanded="false" href="{{route('admin.new_category')}}">+ Create New Category</a>
                    </li>
