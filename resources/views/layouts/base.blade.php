...
<body class="shopping-cart page checkout home-page home-01 ">
            ...
            <div class="container">
                <div class="mid-section main-info-area">
                    ...
                    <div class="wrap-logo-top left-section">
                        <a href="{{route('frontend.home')}}" class="link-to-home"><img
                   ...
                   @livewire('search-header-component')
                    ...
                    <div class="wrap-icon right-section">
                        ...
                        @livewire('wish-list.wish-list-counter-component')
                    ...
                    <div class="container">
                        <ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu">
                            <li class="menu-item home-icon">
                                <a href="{{route('frontend.home')}}" class="link-term mercado-item-title"><i
